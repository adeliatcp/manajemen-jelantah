                                                ...
                                                <?php } else if ($row->status == 3) { ?>
                                                    <tr>
                                                        <td>
                                                            <i class="nav-icon far fa-clock"></i>
                                                            <span class="time"> Hari ini</span>
                                                            <p><b> Pesanan ditolak untuk perangkat <?php echo $row->id_device ?>.</b> Silahkan lakukan pemesanan kembali.
                                                                <a class="btn btn-danger btn-sm" href="<?= base_url('user/order/again/' . $row->id); ?>" style="float:right;text-align:right;">
