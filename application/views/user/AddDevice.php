            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-10">
                            <p></p>
                            <h1 style=" font-size: 27px; font-family:Segoe UI; color: #673E27;">Penambahan Perangkat</h1>
                            <p></p>
                        </div>
                        <div class="col-sm-7">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7" style="float:none;margin:auto;">
                            ...
                            <div class="card">
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form role="form" action="<?php echo base_url('user/dashboard/add_device'); ?>" method="POST">
                                    <div class="card-body">
